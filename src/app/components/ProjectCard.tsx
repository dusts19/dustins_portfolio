...
export default function ProjectCard({ project }: {project: Project }) {
    ...
    return(
        <div className="xs:px-0.5">
            ...
            <Image src={imgSrc} alt={project.title} width={300} height={200} className={`${pathname === '/' ? 'border-2 border-slate-300 mb-5 md:h-48 sm:h-36 sm:mb-3' : 'border-2 border-slate-300 h-48' }`}  />
